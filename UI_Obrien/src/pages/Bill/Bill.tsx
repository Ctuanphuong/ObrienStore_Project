...
import { faArrowAltCircleLeft, faDollar, faPrint } from '@fortawesome/free-solid-svg-icons'
    ...
    <div className={cx('wrapper')}>
      <div className={cx('container')}>
        ...
        <div className={cx('btn-redirect')}>
          <div className={cx('btn-back-home')}>
            <Link to={'/'} className={cx('back-to-home')} id='print-button'>
          ...
          <div className={cx('wrap-btn-print')}>
            ...
            <Link to={'/my-order'} className={cx('btn-print')} id='print-button'>
              Back to your order
            </Link>
          </div>
        </div>
