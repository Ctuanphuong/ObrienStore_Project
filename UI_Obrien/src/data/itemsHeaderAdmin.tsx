...
export const items: MenuItem[] = [
  ...
  getItem('Product', 'sub1', <CodeSandboxOutlined />, [
    getItem(<Link to={'/admin/products'}>View List</Link>, '3'),
    getItem(<Link to={'/admin/products/create'}>Create New</Link>, '4')
  ]),
  getItem('Category', 'sub2', <AppstoreOutlined />, [
    getItem(<Link to={'/admin/categories'}>View List</Link>, '5'),
    getItem(<Link to={'/admin/categories/create'}>Create New</Link>, '6')
  ]),
